...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('show_data_santri_example', compact('students'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/santri/show')->with('status', 'Data Santri Berhasil Ditambahkan!');
    }
    ...
    {
        return view('detail_santri_example', compact('student'));
    }
    ...
    {
        return view('update_data_santri_example', compact('student'));
    }
